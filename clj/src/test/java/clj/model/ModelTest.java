...
public class ModelTest {
    ...
    public ModelTest(ModelViewInterface MVInter){
        board = new BoardTest();
        this.MVInter = MVInter;
    }

    public ModelTest(BoardTest board){
        this.board = board;
    }

    public int runRequest(RequestTest request){
        // declare the string array for arguments with default 0 arguments
        //String[] arguments = new String[0];

        // selected the piece according to the user input index
        PieceTest pickedPiece = this.board.pick(request.getCoord());
